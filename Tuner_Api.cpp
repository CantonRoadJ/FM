...
U32 Get_FM_Min_Freq()
{
    return Radio_AreaConfig.FM_MinFreq;
}

U32 Get_FM_Max_Freq()
{
    return Radio_AreaConfig.FM_MaxFreq;
}

U32 Get_AM_Min_Freq()
{
    return Radio_AreaConfig.AM_MinFreq;
}

U32 Get_AM_Max_Freq()
{
    return Radio_AreaConfig.AM_MaxFreq;
}
...
void Radio_SetCurrentFreq(U16 freq)
{
    Radio_CurrentFreq = freq;
}
...
void Radio_CheckStation(void)
{
    ...
    int fm = (Radio_CurrentBand<=FM3_BAND);
	...
	switch(CheckIfStep)
	{
		...
		case 32:
            ...
            //qDebug("fm = %d", fm);
            //qDebug("SeekSenLevel = %d",SeekSenLevel);
